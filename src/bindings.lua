-- moonglide binding library
-- loaded automatically before user config
-- defines bind.*, on_btn_down, on_btn_up, on_update, and user helpers
...
-- compatibility: void-ify old globals that bindings.lua tests may check
-- (they no longer have meaning in Rust)
